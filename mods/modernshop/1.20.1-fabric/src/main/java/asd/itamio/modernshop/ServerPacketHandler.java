...
public class ServerPacketHandler {
    ...
    private static void handleReorderCategories(ServerPlayer player, String[] categoryNames) {
        try {
            ...
            // Persist the new order using ModernShop's simple file-based persistence
            ModernShop.saveCategoryOrder(reordered);
            player.sendSystemMessage(Component.literal("\u00a77Category order saved to modernshop_category_order.json."));
