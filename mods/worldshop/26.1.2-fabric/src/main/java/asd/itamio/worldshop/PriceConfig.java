 ...
 * A version file tracks the pricing system version. When the version changes,
 * cached prices are automatically cleared.
 */
public class PriceConfig {
    ...
    private static String getItemKey(ItemStack stack) {
        return net.minecraft.core.registries.BuiltInRegistries.ITEM.wrapAsHolder(stack.getItem()).getRegisteredName();
    }
