...
public class ConfigManager {
    ...
    public void loadConfig() {
        ...
        try (FileInputStream fis = new FileInputStream(this.configFile)) {
            ...
            this.loginPattern = this.removeQuotes(props.getProperty("loginpattern", "login"));
            ...
            this.contentPallet = this.removeQuotes(props.getProperty("contentpallet", "abcdefghijklmnopqrstuvwxyz0123456789"));
            this.autoDetectRegister = Boolean.parseBoolean(props.getProperty("autodetectregister", "true"));
            this.registerPattern = this.removeQuotes(props.getProperty("registerpattern", "register"));
            ...
            this.commandFormatRegister = this.removeQuotes(props.getProperty("commandformatregister", "/register $p $p"));
            this.commandFormatLogin = this.removeQuotes(props.getProperty("commandformatlogin", "/login $p"));
            ...
            CredentialManager.displayMessage("Error loading config: " + e.getMessage());
            this.saveConfig();
        }
    }
    ...
    public void reloadConfig() {
        ...
        if (this.showDebugMessages) {
            CredentialManager.displayMessage("Configuration reloaded from disk");
        }
    }
    ...
    public void saveConfig() {
        try {
            ...
            CredentialManager.displayMessage("Error saving config: " + e.getMessage());
        }
    }
    ...
    public boolean isAutoDetectLoginPrompt() {
        this.loadConfig();
        return this.autoDetectLoginPrompt;
    }
    ...
    public boolean isDisableOnceLoggedIn() {
        this.loadConfig();
        return this.disableOnceLoggedIn;
    }

    public boolean isLoginCommandEnabled() {
        this.loadConfig();
        return this.loginCommandEnabled;
    }
    ...
    public String getContentPallet() {
        this.loadConfig();
        return this.contentPallet;
    }

    public boolean isAutoDetectRegister() {
        this.loadConfig();
        return this.autoDetectRegister;
    }
    ...
    public boolean isDisableOnceRegistered() {
        this.loadConfig();
        return this.disableOnceRegistered;
    }

    public boolean isRegisterCommandEnabled() {
        this.loadConfig();
        return this.registerCommandEnabled;
    }
    ...
    public String getCommandFormatRegister() {
        this.loadConfig();
        return this.commandFormatRegister;
    }

    public String getCommandFormatLogin() {
        this.loadConfig();
        return this.commandFormatLogin;
    }
