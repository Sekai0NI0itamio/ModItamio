...
public class ConfigManager {
    ...
    public void loadConfig() {
        ...
        try (FileInputStream fis = new FileInputStream(this.configFile)) {
            ...
            CredentialManager.displayMessage(TextFormatting.RED + "Error loading config: " + e.getMessage());
            this.saveConfig();
        }
    }
    ...
    public void reloadConfig() {
        ...
        if (this.showDebugMessages) {
            CredentialManager.displayMessage(TextFormatting.GREEN + "Configuration reloaded from disk");
        }
    }
    ...
    public void saveConfig() {
        try {
            ...
            CredentialManager.displayMessage(TextFormatting.RED + "Error saving config: " + e.getMessage());
        }
    }
