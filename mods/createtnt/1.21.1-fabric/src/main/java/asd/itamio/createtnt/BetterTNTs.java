...
public class BetterTNTs implements ModInitializer {
    ...
    public void onInitialize() {
        EXPLOSION_BOOM = Registry.register(BuiltInRegistries.SOUND_EVENT,
            ResourceLocation.fromNamespaceAndPath(MOD_ID, "explosion_boom"),
        ...
        ENHANCED_TNT = Registry.register(BuiltInRegistries.ENTITY_TYPE,
            ResourceLocation.fromNamespaceAndPath(MOD_ID, "enhanced_tnt_primed"),
        ...
        ENHANCED_FALLING_BLOCK = Registry.register(BuiltInRegistries.ENTITY_TYPE,
            ResourceLocation.fromNamespaceAndPath(MOD_ID, "enhanced_falling_block"),
        ...
        SHELL_EXPLOSION_SMOKE = Registry.register(BuiltInRegistries.PARTICLE_TYPE,
            ResourceLocation.fromNamespaceAndPath(MOD_ID, "shell_explosion_smoke"), new ShellSmokeParticleType());
        SHELL_EXPLOSION_CLOUD = Registry.register(BuiltInRegistries.PARTICLE_TYPE,
            ResourceLocation.fromNamespaceAndPath(MOD_ID, "shell_explosion_cloud"), new ShellCloudParticleType());
        SHELL_BLAST_WAVE = Registry.register(BuiltInRegistries.PARTICLE_TYPE,
            ResourceLocation.fromNamespaceAndPath(MOD_ID, "shell_blast_wave"), new BlastWaveParticleType());

        // Explosion payload channel (server → client).
        PayloadTypeRegistry.playS2C().register(SpawnExplosionMessage.TYPE,
